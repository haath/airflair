...
class FlightsCli
{
    ...
    public function new(args: Array<String>)
    {
        ...
        if (help)
        {
            Sys.println('Usage: flights-cli [from IATA] [to IATA]');
...
$ flights-cli AMS ATH --depart-from 01.03 --depart-to 15.03

Round-trips from Amsterdam to Athens on specific dates

$ flights-cli AMS ATH --depart 01.03 --return 12.03

Round-trips with a specific departure date, but a variety of return dates

$ flights-cli AMS ATH --depart 01.03 --return-from 05.03 --return-to 08.03

Round-trips spanning a specified number of days

$ flights-cli AMS ATH --depart-from 01.03 --depart-to 03.03 --days 5
$ flights-cli AMS ATH --depart 01.03 --days-from 5 --days-to 7
...
$ flights-cli AMS --depart-from 01.03 --depart-to 03.03 \\
              ATH --stay 5 \\
              WAW --until 12.03 \\
              AMS
        ';
